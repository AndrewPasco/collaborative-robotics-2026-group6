...
static const _CloudIndexed_type_support_symbol_names_t _CloudIndexed_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gpd_ros2_interfaces, msg, CloudIndexed)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gpd_ros2_interfaces, msg, CloudIndexed)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gpd_ros2_interfaces, msg, CloudIndexed)() {
  return &::gpd_ros2_interfaces::msg::rosidl_typesupport_c::CloudIndexed_message_type_support_handle;
}
