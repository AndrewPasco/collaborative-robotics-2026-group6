...
static const _CloudSamples_type_support_symbol_names_t _CloudSamples_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gpd_ros2_interfaces, msg, CloudSamples)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, gpd_ros2_interfaces, msg, CloudSamples)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, gpd_ros2_interfaces, msg, CloudSamples)() {
  return &::gpd_ros2_interfaces::msg::rosidl_typesupport_c::CloudSamples_message_type_support_handle;
}
