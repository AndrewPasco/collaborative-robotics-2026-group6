...
static const _CloudSources_type_support_symbol_names_t _CloudSources_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpd_ros2_interfaces, msg, CloudSources)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpd_ros2_interfaces, msg, CloudSources)),
  }
};
...
{
  return &::gpd_ros2_interfaces::msg::rosidl_typesupport_cpp::CloudSources_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gpd_ros2_interfaces, msg, CloudSources)() {
  return get_message_type_support_handle<gpd_ros2_interfaces::msg::CloudSources>();
}
