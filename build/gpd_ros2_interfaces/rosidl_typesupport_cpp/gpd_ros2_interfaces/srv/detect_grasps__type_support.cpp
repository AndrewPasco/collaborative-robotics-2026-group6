...
static const _DetectGrasps_Request_type_support_symbol_names_t _DetectGrasps_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpd_ros2_interfaces, srv, DetectGrasps_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpd_ros2_interfaces, srv, DetectGrasps_Request)),
  }
};
...
{
  return &::gpd_ros2_interfaces::srv::rosidl_typesupport_cpp::DetectGrasps_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gpd_ros2_interfaces, srv, DetectGrasps_Request)() {
  return get_message_type_support_handle<gpd_ros2_interfaces::srv::DetectGrasps_Request>();
}
...
static const _DetectGrasps_Response_type_support_symbol_names_t _DetectGrasps_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpd_ros2_interfaces, srv, DetectGrasps_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpd_ros2_interfaces, srv, DetectGrasps_Response)),
  }
};
...
{
  return &::gpd_ros2_interfaces::srv::rosidl_typesupport_cpp::DetectGrasps_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, gpd_ros2_interfaces, srv, DetectGrasps_Response)() {
  return get_message_type_support_handle<gpd_ros2_interfaces::srv::DetectGrasps_Response>();
}
...
static const _DetectGrasps_type_support_symbol_names_t _DetectGrasps_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpd_ros2_interfaces, srv, DetectGrasps)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpd_ros2_interfaces, srv, DetectGrasps)),
  }
};
...
{
  return &::gpd_ros2_interfaces::srv::rosidl_typesupport_cpp::DetectGrasps_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, gpd_ros2_interfaces, srv, DetectGrasps)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<gpd_ros2_interfaces::srv::DetectGrasps>();
}
