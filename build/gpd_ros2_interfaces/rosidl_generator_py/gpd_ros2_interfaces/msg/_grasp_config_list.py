...
class Metaclass_GraspConfigList(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from gpd_ros2_interfaces.msg import GraspConfig
...
class GraspConfigList(metaclass=Metaclass_GraspConfigList):
    ...
    _fields_and_field_types = {
        ...
        'grasps': 'sequence<gpd_ros2_interfaces/GraspConfig>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['gpd_ros2_interfaces', 'msg'], 'GraspConfig')),  # noqa: E501
    )
