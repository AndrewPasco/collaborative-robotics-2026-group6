...
#include "gpd_ros2_interfaces/msg/detail/grasp_config__rosidl_typesupport_fastrtps_c.h"
...
using _GraspConfig__ros_msg_type = gpd_ros2_interfaces__msg__GraspConfig;
...
static uint32_t _GraspConfig__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gpd_ros2_interfaces__msg__GraspConfig(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gpd_ros2_interfaces__msg__GraspConfig;
    is_plain =
      (
...
static size_t _GraspConfig__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gpd_ros2_interfaces__msg__GraspConfig(
