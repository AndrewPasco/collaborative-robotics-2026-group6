...
#include "gpd_ros2_interfaces/msg/detail/cloud_samples__rosidl_typesupport_fastrtps_c.h"
...
#include "gpd_ros2_interfaces/msg/detail/cloud_sources__functions.h"  // cloud_sources
...
using _CloudSamples__ros_msg_type = gpd_ros2_interfaces__msg__CloudSamples;
  ...
  // Field name: cloud_sources
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, gpd_ros2_interfaces, msg, CloudSources
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _CloudSamples__ros_msg_type * ros_message = static_cast<_CloudSamples__ros_msg_type *>(untyped_ros_message);
  // Field name: cloud_sources
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_gpd_ros2_interfaces__msg__CloudSamples(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _CloudSamples__ros_msg_type * ros_message = static_cast<const _CloudSamples__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_gpd_ros2_interfaces__msg__CloudSources(
...
static uint32_t _CloudSamples__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gpd_ros2_interfaces__msg__CloudSamples(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gpd_ros2_interfaces
size_t max_serialized_size_gpd_ros2_interfaces__msg__CloudSamples(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: cloud_sources
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_gpd_ros2_interfaces__msg__CloudSources(
  ...
  if (is_plain) {
    ...
    using DataType = gpd_ros2_interfaces__msg__CloudSamples;
    is_plain =
      (
...
static size_t _CloudSamples__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gpd_ros2_interfaces__msg__CloudSamples(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gpd_ros2_interfaces, msg, CloudSamples)() {
