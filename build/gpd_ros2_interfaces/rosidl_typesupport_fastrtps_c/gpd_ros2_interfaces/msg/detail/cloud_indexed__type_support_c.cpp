...
#include "gpd_ros2_interfaces/msg/detail/cloud_indexed__rosidl_typesupport_fastrtps_c.h"
...
using _CloudIndexed__ros_msg_type = gpd_ros2_interfaces__msg__CloudIndexed;
  ...
  void * untyped_ros_message)
{
  ...
  _CloudIndexed__ros_msg_type * ros_message = static_cast<_CloudIndexed__ros_msg_type *>(untyped_ros_message);
  // Field name: cloud_sources
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: indices
  {
    ...
    if (ros_message->indices.data) {
      rosidl_runtime_c__int64__Sequence__fini(&ros_message->indices);
    }
...
static uint32_t _CloudIndexed__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gpd_ros2_interfaces__msg__CloudIndexed(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gpd_ros2_interfaces__msg__CloudIndexed;
    is_plain =
      (
...
static size_t _CloudIndexed__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gpd_ros2_interfaces__msg__CloudIndexed(
