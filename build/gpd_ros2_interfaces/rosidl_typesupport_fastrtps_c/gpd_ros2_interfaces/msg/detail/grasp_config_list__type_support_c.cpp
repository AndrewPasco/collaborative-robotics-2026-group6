...
#include "gpd_ros2_interfaces/msg/detail/grasp_config_list__rosidl_typesupport_fastrtps_c.h"
...
#include "gpd_ros2_interfaces/msg/detail/grasp_config__functions.h"  // grasps
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions
size_t get_serialized_size_gpd_ros2_interfaces__msg__GraspConfig(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_gpd_ros2_interfaces__msg__GraspConfig(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gpd_ros2_interfaces, msg, GraspConfig)();
...
using _GraspConfigList__ros_msg_type = gpd_ros2_interfaces__msg__GraspConfigList;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: grasps
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, gpd_ros2_interfaces, msg, GraspConfig
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: grasps
  {
    ...
    if (ros_message->grasps.data) {
      gpd_ros2_interfaces__msg__GraspConfig__Sequence__fini(&ros_message->grasps);
    }
  ...
  size_t current_alignment)
{
  ...
  // field.name grasps
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_gpd_ros2_interfaces__msg__GraspConfig(
...
static uint32_t _GraspConfigList__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gpd_ros2_interfaces__msg__GraspConfigList(
  ...
  size_t current_alignment)
{
  ...
  // member: grasps
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_gpd_ros2_interfaces__msg__GraspConfig(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = gpd_ros2_interfaces__msg__GraspConfigList;
    is_plain =
      (
...
static size_t _GraspConfigList__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gpd_ros2_interfaces__msg__GraspConfigList(
