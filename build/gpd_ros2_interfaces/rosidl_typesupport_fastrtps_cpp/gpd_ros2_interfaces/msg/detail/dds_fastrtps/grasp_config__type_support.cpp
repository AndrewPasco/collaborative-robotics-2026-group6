...
#include "gpd_ros2_interfaces/msg/detail/grasp_config__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gpd_ros2_interfaces::msg::GraspConfig & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gpd_ros2_interfaces::msg::GraspConfig & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gpd_ros2_interfaces::msg::GraspConfig;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gpd_ros2_interfaces::msg::GraspConfig *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gpd_ros2_interfaces::msg::GraspConfig *>(
    untyped_ros_message);
...
{
  return &gpd_ros2_interfaces::msg::typesupport_fastrtps_cpp::_GraspConfig__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpd_ros2_interfaces, msg, GraspConfig)() {
  return &gpd_ros2_interfaces::msg::typesupport_fastrtps_cpp::_GraspConfig__handle;
}
