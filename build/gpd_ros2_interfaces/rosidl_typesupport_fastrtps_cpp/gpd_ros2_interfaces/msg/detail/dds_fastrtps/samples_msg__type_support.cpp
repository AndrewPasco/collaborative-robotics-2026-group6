...
#include "gpd_ros2_interfaces/msg/detail/samples_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gpd_ros2_interfaces::msg::SamplesMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gpd_ros2_interfaces::msg::SamplesMsg & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gpd_ros2_interfaces::msg::SamplesMsg;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gpd_ros2_interfaces::msg::SamplesMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gpd_ros2_interfaces::msg::SamplesMsg *>(
    untyped_ros_message);
...
get_message_type_support_handle<gpd_ros2_interfaces::msg::SamplesMsg>()
{
  return &gpd_ros2_interfaces::msg::typesupport_fastrtps_cpp::_SamplesMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpd_ros2_interfaces, msg, SamplesMsg)() {
  return &gpd_ros2_interfaces::msg::typesupport_fastrtps_cpp::_SamplesMsg__handle;
}
