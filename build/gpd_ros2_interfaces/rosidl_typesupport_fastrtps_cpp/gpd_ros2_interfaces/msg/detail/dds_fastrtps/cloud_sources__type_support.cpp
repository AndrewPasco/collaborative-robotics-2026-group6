...
#include "gpd_ros2_interfaces/msg/detail/cloud_sources__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gpd_ros2_interfaces::msg::CloudSources & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gpd_ros2_interfaces::msg::CloudSources & ros_message)
{
  // Member: cloud
  ...
  size_t current_alignment)
{
  ...
  // Member: camera_source
  {
    ...
    size_t item_size = sizeof(ros_message.camera_source[0]);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gpd_ros2_interfaces::msg::CloudSources;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gpd_ros2_interfaces::msg::CloudSources *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gpd_ros2_interfaces::msg::CloudSources *>(
    untyped_ros_message);
...
get_message_type_support_handle<gpd_ros2_interfaces::msg::CloudSources>()
{
  return &gpd_ros2_interfaces::msg::typesupport_fastrtps_cpp::_CloudSources__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpd_ros2_interfaces, msg, CloudSources)() {
  return &gpd_ros2_interfaces::msg::typesupport_fastrtps_cpp::_CloudSources__handle;
}
