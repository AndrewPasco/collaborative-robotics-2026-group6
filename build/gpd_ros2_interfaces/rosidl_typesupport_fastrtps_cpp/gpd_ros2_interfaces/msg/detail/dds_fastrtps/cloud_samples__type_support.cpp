...
#include "gpd_ros2_interfaces/msg/detail/cloud_samples__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const gpd_ros2_interfaces::msg::CloudSamples & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gpd_ros2_interfaces::msg::CloudSamples & ros_message)
{
  // Member: cloud_sources
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gpd_ros2_interfaces::msg::CloudSamples;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gpd_ros2_interfaces::msg::CloudSamples *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gpd_ros2_interfaces::msg::CloudSamples *>(
    untyped_ros_message);
...
get_message_type_support_handle<gpd_ros2_interfaces::msg::CloudSamples>()
{
  return &gpd_ros2_interfaces::msg::typesupport_fastrtps_cpp::_CloudSamples__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gpd_ros2_interfaces, msg, CloudSamples)() {
  return &gpd_ros2_interfaces::msg::typesupport_fastrtps_cpp::_CloudSamples__handle;
}
