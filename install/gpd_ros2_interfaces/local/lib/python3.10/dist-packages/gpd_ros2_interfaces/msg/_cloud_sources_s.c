...
bool gpd_ros2_interfaces__msg__cloud_sources__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gpd_ros2_interfaces.msg._cloud_sources.CloudSources", full_classname_dest, 51) == 0);
  }
  gpd_ros2_interfaces__msg__CloudSources * ros_message = _ros_message;
  {  // cloud
  ...
  {  // camera_source
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int64_t * dest = ros_message->camera_source.data;
...
PyObject * gpd_ros2_interfaces__msg__cloud_sources__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gpd_ros2_interfaces.msg._cloud_sources");
  ...
  {  // camera_source
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "camera_source");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->camera_source.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int64_t * src = &(ros_message->camera_source.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->camera_source.size * sizeof(int64_t));
      assert(data != NULL);
