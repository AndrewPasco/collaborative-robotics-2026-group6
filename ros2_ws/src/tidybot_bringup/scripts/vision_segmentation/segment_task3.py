    ...
    def _run_detection(self, ros_img, arm_status):
        ...
        try:
            ...
            if bbox_norm:
                ...
                padding = 3
                x1, y1 = int(xmin * w / 1000)-padding, int(ymin * h / 1000)-padding
                x2, y2 = int(xmax * w / 1000)+padding, int(ymax * h / 1000)+padding
                ...
                self.get_logger().warn(f'Could not locate {info["label"]}')
